...
async def on_member_join(member):
    ...
    channel = client.get_channel(823488337029365762)
    embed = discord.Embed(title="Welcome to The Løst Legion!", description=f"{member.mention} Joined", color=0x00ffcc)
...
async def on_member_remove(member):
    ...
    channel = client.get_channel(823488337029365762)
    embed = discord.Embed(title="Goodbye", description=f"{member.mention} Left", color=0x00ffcc)
